...
class LoginViewModel @ViewModelInject constructor(private val dataRepository: DataRepository, private val errorMapper: ErrorMapper) :
    BaseViewModel() {
    override val errorManager: ErrorManager
        get() = ErrorManager(errorMapper)

    private val _newsLiveData = MutableLiveData<Resource<TestPoc>>()
    val newsLiveData: LiveData<Resource<TestPoc>> get() = _newsLiveData
    ...
    fun callApi() {
        ...
        viewModelScope.launch {
            _newsLiveData.value = dataRepository.requestNews() as Resource<TestPoc>
        }
    }
}